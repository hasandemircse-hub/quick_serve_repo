...
class _CashierScreenState extends State<CashierScreen> {
  ...
  Future<void> _takePayment() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: const Text('Ödeme başarıyla alındı.'),
      ...
      if (!mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Ödeme alınamadı: $e')),
      );
    } finally {
        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              ...
              _methodChip('CREDIT_CARD', 'Kredi Karti'),
  ...
  Future<void> _closeTableFromCashier() async {
    ...
    try {
      ...
      if (!mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Masa kapatilamadi: $e')),
      );
    }
  }
