...
public class Restaurant {
    ...
    @Column(name = "is_menu_images_enabled", nullable = false)
    @Builder.Default
    private Boolean isMenuImagesEnabled = false;

    @Column(name = "is_pos_device_enabled", nullable = false)
    @Builder.Default
    private Boolean isPosDeviceEnabled = false;
