...
class LocalStorage {
  ...
  static const _isMenuImagesEnabledKey = 'restaurant_menu_images_enabled';
  static const _isPosDeviceEnabledKey = 'restaurant_pos_device_enabled';
  ...
  static Future<void> saveUserInfo({
    ...
    bool isMenuImagesEnabled = false,
    bool isPosDeviceEnabled = false,
  }) async {
    final prefs = await SharedPreferences.getInstance();
    ...
    await prefs.setBool(_isMenuImagesEnabledKey, isMenuImagesEnabled);
    await prefs.setBool(_isPosDeviceEnabledKey, isPosDeviceEnabled);
  }
  ...
  static Future<Map<String, dynamic>> getUserInfo() async {
    ...
    return {
      ...
      'isMenuImagesEnabled': prefs.getBool(_isMenuImagesEnabledKey) ?? false,
      'isPosDeviceEnabled': prefs.getBool(_isPosDeviceEnabledKey) ?? false,
    };
  }
  ...
  static Future<void> clearUserInfo() async {
    ...
    await prefs.remove(_isMenuImagesEnabledKey);
    await prefs.remove(_isPosDeviceEnabledKey);
  }
}
